...
public class ApplicationConfig {
    ...
    @Bean
    public ConsumerFactory<String, HistoryTicket> consumerFactory(
        ...
        var kafkaConsumerFactory = new DefaultKafkaConsumerFactory<String, HistoryTicket>(props);
        kafkaConsumerFactory.setValueDeserializer(new JsonDeserializer<>(mapper));
        return kafkaConsumerFactory;
    }

    @Bean("listenerContainerFactory")
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, HistoryTicket>>
    listenerContainerFactory(ConsumerFactory<String, HistoryTicket> consumerFactory) {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, HistoryTicket>();
    ...
    public static class KafkaClient {
        ...
        public void listen(@Payload List<HistoryTicket> values) {
            log.info("values, values.size:{}", values.size());
            service.greatTicket(values);
        }
    }
}
